...
$update_sql = "UPDATE sessions SET session_status = 'Accepted' WHERE session_id = ?";
$update_stmt = $conn->prepare($update_sql);
$update_stmt->bind_param("i", $session_id);

if ($update_stmt->execute()) {
    $_SESSION['message'] = "Session accepted successfully!";
    $_SESSION['message_type'] = "success";
} else {
    $_SESSION['message'] = "Error accepting session.";
