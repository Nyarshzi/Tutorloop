...
if (!isset($_SESSION['user_id'])) {
    // For development, you can temporarily hardcode: $_SESSION['user_id'] = 2;
...
// Fetch the list of tutors the user has a conversation history with
        ...
        <div class="messages">
            <div class="contacts">
                ...
                <?php if ($contacts_result && $contacts_result->num_rows > 0): ?>
                    ...
                    <?php endwhile; ?>
                <?php else: ?>
                    <p style="padding: 10px; font-size: 13px; color: #666;">No tutors found.</p>
                <?php endif; ?>
            </div>

            <div class="chat">
                <div class="chat-header">
                    <?php echo htmlspecialchars($selected_tutor_name); ?>
                </div>
                ...
                <div class="chat-body">
                    ...
                    <?php else: ?>
                        <div style="display: flex; height: 100%; align-items: center; justify-content: center; color: #888;">
                            Select a tutor to view your messages
                        </div>
                    <?php endif; ?>
                </div>
